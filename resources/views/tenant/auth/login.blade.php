...
<head>
    ...
    <title>Login Penghuni - RumahKos</title>
        ...
        <div class="bg-white shadow-2xl rounded-2xl p-8 md:p-10 transition-all duration-300 hover:shadow-blue-500/20">
            ...
            <form method="POST" action="{{ route('tenant.login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <a href="{{ route('tenant.password.request') }}" class="text-blue-600 font-medium hover:text-blue-700 hover:underline">
                        Lupa password?
                    </a>
                </div>
            ...
            <p class="text-center text-sm text-slate-600 mt-6">
                Belum punya akun? 
                <a href="{{ route('tenant.register') }}" class="text-blue-600 font-semibold hover:text-blue-700 hover:underline">
                    Daftar di sini
                </a>
            </p>
