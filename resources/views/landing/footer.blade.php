    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <p class="text-sm text-gray-400">
          {{ $description?->description ?? $globalProperty?->description ?? 'Kos Nyaman bersih dan strategis di Bandung' }}
        </p>
      </div>
      ...
      <div>
        ...
        <div class="space-y-3 text-sm text-gray-400">
          <p class="flex items-center gap-2">
            ...
            {{ $contact?->phone ?? $globalProperty?->phone ?? '08123456789' }}
          </p>

          <p class="flex items-center gap-2">
            <i class="fab fa-whatsapp text-lg"></i>
            {{ $contact?->whatsapp ?? $globalProperty?->whatsapp ?? '08123456789' }}
          </p>
          ...
          <p class="flex items-center gap-2">
            ...
            {{ $address?->address ?? $globalProperty?->address ?? 'Jl. Contoh Alamat No.123, Bandung' }}
          </p>
        </div>
      </div>
