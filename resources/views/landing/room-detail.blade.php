...
<head>
    ...
    @php
        $schemaJson = \App\Services\SeoService::getRoomSchema($room, $globalProperty ?? null);
    @endphp
    @include('components.seo-head', [
        'title' => ($room->name ?? 'Detail Kamar') . ' - RumahKos',
        'description' => $room->description ?? 'Detail kamar kost eksklusif.',
